...
CREATE TABLE `ims_scene_config` (
  ...
  `expire` int(10) unsigned NOT NULL DEFAULT 1 COMMENT '消息有效时长(小时)',
...
('27c3a319dc7011e9bc200242ac110004', '0001', 4, '验证码登录', '验证码登录', '短信验证码', json_array("code", "minutes", "sign"), '系统', '00000000000000000000000000000000', now()),
('27c3a435dc7011e9bc200242ac110004', '0002', 4, '验证手机号', '验证手机号', '短信验证码', json_array("code", "minutes", "sign"), '系统', '00000000000000000000000000000000', now()),
('27c3a589dc7011e9bc200242ac110004', '0003', 4, '新用户注册', '新用户注册', '短信验证码', json_array("code", "minutes", "sign"), '系统', '00000000000000000000000000000000', now()),
('27c3a5d2dc7011e9bc200242ac110004', '0004', 4, '设置登录密码', '设置登录密码', '短信验证码', json_array("code", "minutes", "sign"), '系统', '00000000000000000000000000000000', now()),
('27c3a61adc7011e9bc200242ac110004', '0005', 4, '设置支付密码', '设置支付密码', '短信验证码', json_array("code", "minutes", "sign"), '系统', '00000000000000000000000000000000', now()),
('27c3a661dc7011e9bc200242ac110004', '0006', 4, '手机解除绑定', '手机解除绑定', '短信验证码', json_array("code", "minutes", "sign"), '系统', '00000000000000000000000000000000', now());
INSERT ims_scene_config (id, scene_id, content, sign, creator, creator_id, created_time) VALUES 
(replace(uuid(), '-', ''), '27c3a319dc7011e9bc200242ac110004', '[{code}]是您登录Insight系统的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '27c3a435dc7011e9bc200242ac110004', '[{code}]是您的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '27c3a589dc7011e9bc200242ac110004', '[{code}]是您注册Insight系统的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '27c3a5d2dc7011e9bc200242ac110004', '[{code}]是您重设Insight系统登录密码的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '27c3a61adc7011e9bc200242ac110004', '[{code}]是您设置Insight系统支付密码的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', '00000000000000000000000000000000', now()),
(replace(uuid(), '-', ''), '27c3a661dc7011e9bc200242ac110004', '[{code}]是您解除Insight系统绑定手机号的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', '00000000000000000000000000000000', now());
