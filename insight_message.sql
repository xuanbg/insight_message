...
('387e156ddc7211e9bc200242ac110004', '2564cd559cd340f0b81409723fd8632a', '0001', '短信验证码', 4, '验证码登录', '[{code}]是您登录Insight系统的验证码,请在{minutes}分钟内使用.', NULL, 'Insight系统登录验证码', NULL, '系统', '00000000000000000000000000000000', now()),
('387e1604dc7211e9bc200242ac110004', '2564cd559cd340f0b81409723fd8632a', '0002', '短信验证码', 4, '验证手机号', '[{code}]是您的验证码,请在{minutes}分钟内使用.', NULL, 'Insight系统验证手机号验证码', NULL, '系统', '00000000000000000000000000000000', now()),
('387e165adc7211e9bc200242ac110004', '2564cd559cd340f0b81409723fd8632a', '0003', '短信验证码', 4, '新用户注册', '[{code}]是您注册Insight系统的验证码,请在{minutes}分钟内使用.', NULL, 'Insight系统新用户注册验证码', NULL, '系统', '00000000000000000000000000000000', now()),
('387e16b2dc7211e9bc200242ac110004', '2564cd559cd340f0b81409723fd8632a', '0004', '短信验证码', 4, '设置登录密码', '[{code}]是您重设Insight系统登录密码的验证码,请在{minutes}分钟内使用.', NULL, 'Insight系统设置登录密码验证码', NULL, '系统', '00000000000000000000000000000000', now()),
('387e1706dc7211e9bc200242ac110004', '2564cd559cd340f0b81409723fd8632a', '0005', '短信验证码', 4, '设置支付密码', '[{code}]是您设置Insight系统支付密码的验证码,请在{minutes}分钟内使用.', NULL, 'Insight系统设置支付密码验证码', NULL, '系统', '00000000000000000000000000000000', now()),
('387e1759dc7211e9bc200242ac110004', '2564cd559cd340f0b81409723fd8632a', '0006', '短信验证码', 4, '手机解除绑定', '[{code}]是您解除Insight系统绑定手机号的验证码,请在{minutes}分钟内使用.', NULL, 'Insight系统手机解除绑定验证码', NULL, '系统', '00000000000000000000000000000000', now());
