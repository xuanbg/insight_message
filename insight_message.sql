...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='消息推送表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='消息订阅表,只能订阅广播消息';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='短信发送场景表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='场景模板配置表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='任务队列表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='用户设备表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='用户标签表';


-- 初始化场景数据
INSERT ims_scene(id, code, type, `name`, title, tag, `param`, creator, creator_id, created_time)
VALUES (168140442586578964, '0001', 4, '验证码登录', '验证码登录', '短信验证码', json_array("code", "minutes", "sign"),
        '系统', 0, now()),
       (168140442624327700, '0002', 4, '验证手机号', '验证手机号', '短信验证码', json_array("code", "minutes", "sign"),
        '系统', 0, now()),
       (168140442653687828, '0003', 4, '新用户注册', '新用户注册', '短信验证码', json_array("code", "minutes", "sign"),
        '系统', 0, now()),
       (168140442687242260, '0004', 4, '设置登录密码', '设置登录密码', '短信验证码',
        json_array("code", "minutes", "sign"), '系统', 0, now()),
       (168687422501027860, '0005', 4, '设置支付密码', '设置支付密码', '短信验证码',
        json_array("code", "minutes", "sign"), '系统', 0, now()),
       (168687422542970900, '0006', 4, '手机解除绑定', '手机解除绑定', '短信验证码',
        json_array("code", "minutes", "sign"), '系统', 0, now());
INSERT ims_scene_config (id, scene_id, content, sign, creator, creator_id, created_time)
VALUES (168687422589108244, 168140442586578964, '[{code}]是您登录Insight系统的验证码,请在{minutes}分钟内使用【{sign}】',
        'Insight', '系统', 0, now()),
       (168687422672994324, 168140442624327700, '[{code}]是您的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight',
        '系统', 0, now()),
       (168687422727520276, 168140442653687828, '[{code}]是您注册Insight系统的验证码,请在{minutes}分钟内使用【{sign}】',
        'Insight', '系统', 0, now()),
       (168687422761074708, 168140442687242260,
        '[{code}]是您重设Insight系统登录密码的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', 0, now()),
       (168687422782046228, 168687422501027860,
        '[{code}]是您设置Insight系统支付密码的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', 0, now()),
       (168687422803017748, 168687422542970900,
        '[{code}]是您解除Insight系统绑定手机号的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', '系统', 0, now());
