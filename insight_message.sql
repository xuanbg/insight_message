...
('27c3a319dc7011e9bc200242ac110004', '0001', '验证码登录', '验证码登录', json_array("code", "minutes", "sign"), '短信验证码', 4, '[{code}]是您登录Insight系统的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', 'Insight系统登录验证码', '系统', '00000000000000000000000000000000', now()),
('27c3a435dc7011e9bc200242ac110004', '0002', '验证手机号', '验证手机号', json_array("code", "minutes", "sign"), '短信验证码', 4, '[{code}]是您的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', 'Insight系统验证手机号验证码', '系统', '00000000000000000000000000000000', now()),
('27c3a589dc7011e9bc200242ac110004', '0003', '新用户注册', '新用户注册', json_array("code", "minutes", "sign"), '短信验证码', 4, '[{code}]是您注册Insight系统的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', 'Insight系统新用户注册验证码', '系统', '00000000000000000000000000000000', now()),
('27c3a5d2dc7011e9bc200242ac110004', '0004', '设置登录密码', '设置登录密码', json_array("code", "minutes", "sign"), '短信验证码', 4, '[{code}]是您重设Insight系统登录密码的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', 'Insight系统设置登录密码验证码', '系统', '00000000000000000000000000000000', now()),
('27c3a61adc7011e9bc200242ac110004', '0005', '设置支付密码', '设置支付密码', json_array("code", "minutes", "sign"), '短信验证码', 4, '[{code}]是您设置Insight系统支付密码的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', 'Insight系统设置支付密码验证码', '系统', '00000000000000000000000000000000', now()),
('27c3a661dc7011e9bc200242ac110004', '0006', '手机解除绑定', '手机解除绑定', json_array("code", "minutes", "sign"), '短信验证码', 4, '[{code}]是您解除Insight系统绑定手机号的验证码,请在{minutes}分钟内使用【{sign}】', 'Insight', 'Insight系统手机解除绑定验证码', '系统', '00000000000000000000000000000000', now());
